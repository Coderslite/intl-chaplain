...
<!-- Mirrored from corporx.themetags.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Mar 2026 00:11:56 GMT -->
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-dark navbar-theme-primary fixed-top headroom">
            <div class="container position-relative">
                <a class="navbar-brand mr-lg-3" href="index.html">
                    <img class="navbar-brand-dark" src="assets/img/client-logos/logo.png" alt="menuimage"
                        style="width:60px;">
                    <img class="navbar-brand-light" src="assets/img/client-logos/logo.png" alt="menuimage"
                        style="width:60px;">
                </a>
                    ...
                    <div class="navbar-collapse-header">
                        <div class="row">
                            <div class="col-6 collapse-brand">
                                <a href="#">
                                    <img src="assets/img/client-logos/logo.png" alt="menuimage" style="width:40px;">
                                </a>
                            </div>
