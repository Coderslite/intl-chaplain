                ...
                <div class="rounded-custom text-center shadow-sm">
                    <div class="card-body py-5">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">+1813.699.9138</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="rounded-custom text-center shadow-sm">
                    <div class="card-body py-5">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">283 Midway GA 31320</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="rounded-custom text-center shadow-sm">
                    <div class="card-body py-5">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">cmintlcorp@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-around">
            ...
            <div class="col-md-5">
                <div class="contact-us-content">
                    ...
                    <p class="lead">Send your questions to us using the contact form below, and we will be get back to
                        you in the shortest possible time</p>

                    <a href="#" class="btn btn-outline-secondary align-items-center">Get Directions <span
                    ...
                    <address>
                       PO Box 283 Midway GA 31320
                    </address>
                    <br>
                    <span>Phone: +1813.699.9138</span> <br>
                    <span>Email: <a href="mailto:cmintlcorp@gmail.com"
                            class="link-color">cmintlcorp@gmail.com</a></span>
